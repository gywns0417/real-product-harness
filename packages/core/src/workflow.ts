...
export const WORKFLOW_STAGES: Record<WorkflowStageId, WorkflowStage> = {
  ...
  PM_DIFFERENTIATION: stage("PM_DIFFERENTIATION", "Differentiation", "PM", ["PM_COMPETITOR_ANALYSIS"], ["competitor-analysis"], [], ["PM_REQUIREMENTS_INTERVIEW"], ["PM_COMPETITOR_ANALYSIS"]),
  PM_REQUIREMENTS_INTERVIEW: stage("PM_REQUIREMENTS_INTERVIEW", "Requirements interview", "PM", ["PM_DIFFERENTIATION"], [], [], ["PM_REQUIREMENTS_DRAFT"], ["PM_DIFFERENTIATION"]),
  ...
  PM_APPROVED: stage("PM_APPROVED", "PM approved", "Orchestrator", ["PM_FEATURE_DEFINITION_APPROVED"], ["product-definition", "requirements", "screen-definition", "feature-definition"], ["product-definition", "requirements", "screen-definition", "feature-definition"], ["PD_REFERENCES"], ["PM_FEATURE_DEFINITION_APPROVED"]),
