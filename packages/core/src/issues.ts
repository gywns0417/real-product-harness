...
export function createWorkIssue(projectRoot: string, input: CreateWorkIssueInput): WorkIssue {
  ...
  const issue: WorkIssue = {
    ...
    acceptanceCriteria: input.acceptanceCriteria ?? [
      "Implementation follows linked product and engineering documents.",
      "Relevant lint, test, and build checks pass before PR handoff.",
      "User approval remains required before merge or deployment."
    ],
